...
@ubot.on_message(filters.me & filters.command("pingx", cmd))
...
<b>{cos_ping2} Uptime `28d:11h:{uptime}`</b>
"""
...
async def _(client, callback_query):
    if callback_query.from_user.id in DEVS:
        buttons = [
            ...
            [
                InlineKeyboardButton("📣 Join Dahulu", url="https://t.me/lassupportt"),
...
async def _(_, message):
    if message.from_user.id in DEVS:
        buttons = [
            ...
            [
                InlineKeyboardButton("📣 Join Dahulu", url=f"https://t.me/lassupportt"),
                InlineKeyboardButton("🤖 Bantuan", callback_data="support")
            ]
        ]
    else:
